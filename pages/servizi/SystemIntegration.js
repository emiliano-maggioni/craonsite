        ...
        <div className={classes.content}>
          ...
          <div className={classes.pageElements}>
            <div className={classes.defImage}>
              <img src="/servizi/system_integration_mc.png" className="img-fluid" alt="System Integration Microsofot Certifidied" />
            </div>
          ...
          <div className={classes.content}>
            ...
            <div className={classes.bottomB2b}>
              <figure><img src="/b2b_cart_logo.png" className="img-fluid d-block m-auto" alt="B2B E-commerce Business To Business Lead Management " /></figure>
